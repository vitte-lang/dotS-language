...
copy_sync "$SRC/dotS-language.geany" "$ROOT/dotS-language.geany"
copy_sync "$SRC/dotS-language.strict-dev.geany" "$ROOT/dotS-language.strict-dev.geany"
copy_sync "$SRC/dotS-language.docs.geany" "$ROOT/dotS-language.docs.geany"
copy_sync "$SRC/dotS-language.perf.geany" "$ROOT/dotS-language.perf.geany"
copy_sync "$SRC/dotS-language.runtime.geany" "$ROOT/dotS-language.runtime.geany"
copy_sync "$SRC/dotS-language.strict-runtime.geany" "$ROOT/dotS-language.strict-runtime.geany"
